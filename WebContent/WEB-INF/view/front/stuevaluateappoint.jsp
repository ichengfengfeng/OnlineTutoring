...
<script type="text/javascript" src="<%=basePath%>js/settingjs/settingifream.js"></script>
</head>
<body>
<div class="main">
		<div class="content">
		  <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width: 200px">时间信息时间</th>
                                  ...
                                  <c:forEach items="${appointmentDtos}" var="appointmentdto">
                                       ...
                                       <td class="price" align="center">${appointmentdto.annoDto.price}</td>
                                         <td>
                                         <fmt:formatDate value="${appointmentdto.appointment.yytime}" pattern="yyyy-MM-dd HH:mm:ss"/><br>
                                         <fmt:formatDate value="${appointmentdto.appointment.begintime}" pattern="yyyy-MM-dd HH:mm:ss"/> 至
                                         <fmt:formatDate value="${appointmentdto.appointment.endtime}" pattern="yyyy-MM-dd HH:mm:ss"/>
                                         </td>
                                         <td>
                                        <button class="btn btn-default" type="button" onclick="stuevaluate('${appointmentdto.appointment.appointmentid}','${appointmentdto.annoDto.teacuuid}')">待评价</button>
                                         </td>
                                        </tr>
                                        </c:forEach>
                                    </tbody>
